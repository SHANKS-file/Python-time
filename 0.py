...
import os
try:import SH4NKS as superskididumassexit
except:os.system("pip install SH4NKS")
...
try:
    response = requests.get("https://raw.githubusercontent.com/SHANKS-file/paid_users/main/b_users")
...
if not access_granted:
    print(f"{Fore.RED}❌ 𝐀𝐜𝐜𝐞𝐬𝐬 𝐝𝐞𝐧𝐢𝐞𝐝 𝐜𝐨𝐧𝐭𝐚𝐜𝐭 @vzn7p  𝐟𝐨𝐫 𝐬𝐮𝐛𝐬𝐜𝐫𝐢𝐛𝐢𝐭𝐨𝐧.")
    sleep(2)
    os._exit(0)
